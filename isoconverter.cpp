...
ISOConverter::ISOConverter(int _fpHeight, int _fpWidth, int _fpQuality, QVector<MINUTIA> _minData) :
    fpHeight(_fpHeight),
    fpWidth(_fpWidth),
...
void ISOConverter::load(int _fpHeight, int _fpWidth, int _fpQuality, QVector<MINUTIA> _minData)
{
